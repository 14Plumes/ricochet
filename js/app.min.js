...
function createShadow(game) {
    var shadow = game.add.sprite(0, 0, 'disc-shadow');
...
function updateShadow(shadow, disc, water) {
    if (disc.alive) {
        shadow.visible = true;
        shadow.position.x = disc.position.x;
        shadow.position.y = water.body.top;
    } else {
        shadow.visible = false;
    }
}
...
play.create = function create() {
    ...
    this.shadow = createShadow(this.game);
...
play.update = function update() {
    ...
    updateShadow(shadow, disc, water);
};
...
preloader.preload = function preload() {
    ...
    this.game.load.image('disc-shadow', './images/disc-shadow15x10.png', 15, 10);

...
module.exports={
  ...
  "repository": {
    "type": "git",
    "url": "git@github.com:14Plumes/ld38.git"
  },
  "browserify-shim": {
...
},{"./properties":4,"./states/boot.js":5,"./states/play.js":6,"./states/preloader.js":7,"lodash":1}],4:[function(require,module,exports){
'use strict';
...
function addStats(game) {
    ...
    return function () {
        ...
        stats.begin();
        oldUpdate.call.apply(oldUpdate, [game].concat(args));
        stats.end();
    };
}
...
},{"../../lib/stats.min":8,"../properties":4}],6:[function(require,module,exports){
'use strict';
...
function createWater(game, height) {
    var water = game.add.tileSprite(0, height - 128, game.world.width, 128, 'water');
...
function createDisc(game) {
    var disc = game.add.sprite(32, game.world.height * 0.7, 'disc');
    var anim = disc.animations.add('rotate');
    anim.play(20, true);
...
function createSky(game, height) {
    var sky = game.add.tileSprite(0, height - 172, game.world.width, 88, 'sky');
    sky.scale.setTo(2, 2);
...
function makeSplash(game, disc) {
    ...
    var splash = game.add.sprite(disc.centerX, disc.bottom, 'splash', 5);
    splash.anchor.setTo(0.5, 1);

    // Adapt animation to disc velocity
    var lastFrame = _.clamp(1, _.floor(-disc.body.velocity.y / 25), 6);
    var frameOrder = _.range(0, lastFrame);
    splash.animations.add('up', frameOrder);
    splash.animations.add('down', _.reverse(frameOrder));

    // Animation up
    splash.animations.play('up', 20).onComplete.add(function () {
        // then down
        splash.animations.play('down', 20, false, // no loop
        true);
    });
}

function handleInput(game) {
    var key = game.input.keyboard;
...
},{"../properties":4,"lodash":1}],7:[function(require,module,exports){
'use strict';
...
preloader.preload = function preload() {
    ...
    this.game.load.spritesheet('disc', 'images/disc15x10.png', 15, 10, 3);
...
;var __browserify_shim_require__ = require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
  (function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.Stats = factory();
  })(this, function () {
    'use strict';
